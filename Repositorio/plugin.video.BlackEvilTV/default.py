...
g_ignoreSetResolved=['plugin.video.dramasonline','plugin.video.shahidmbcnet','plugin.stream.vaughnlive.tv']
...
Base = 'https://raw.githubusercontent.com/josetg01/BlackEvilTV/master/Codigos/inicio.xml' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.BlackEvilTV') #    modificar("el nombre de tu addons")
